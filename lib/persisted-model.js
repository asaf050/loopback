...
module.exports = function (registry) {
  ...
  PersistedModel.enableChangeTracking = function () {
    ...
    Model.observe('after save', Model.rectifyOnSave);

    Model.observe('after delete', Model.rectifyOnDelete);
  ...
  Model.rectifyOnSave = function (ctx, next) {
  ...
  Model.rectifyOnDelete = function (ctx, next) {
